...
- Source Reader v0.7 developer workflow: `read-window`, `read-document`, `read-section`, `read-parallel`, `search --with-window`
- Evidence Pin v0.8 workflow: `pin-evidence`, `evidence list`, `evidence show`, investigate candidate/pinned evidence
...
python -m genshin_lore_db evidence list --role supports
